...
const VARIANT_CLASS: Record<Variant, string> = {
  ...
  danger:
    "border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 disabled:opacity-50 dark:border-red-900 dark:bg-red-950 dark:text-red-400 dark:hover:bg-red-900",
