...
public class ImagePromptController {
    ...
    public ResponseEntity<ImagePromptSetDto> generateForScript(Authentication authentication,
                                                                @PathVariable UUID scriptId) {
        return ResponseEntity.ok(
                imagePromptGenerationApplicationService.generateForScript(scriptId, currentUserId(authentication)));
    }
    ...
    public ResponseEntity<ImagePromptSetDto> generateForCarousel(Authentication authentication,
                                                                  @PathVariable UUID carouselId) {
        return ResponseEntity.ok(
                imagePromptGenerationApplicationService.generateForCarousel(carouselId, currentUserId(authentication)));
    }
