...
public class EvaluationController {
    ...
    @PostMapping
    public ResponseEntity<ContentEvaluationDto> evaluate(@RequestBody PostEvaluationRequest request) {
        return ResponseEntity.ok(postEvaluationApplicationService.evaluate(request));
    }
