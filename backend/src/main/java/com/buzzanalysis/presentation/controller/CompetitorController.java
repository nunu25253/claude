...
public class CompetitorController {
    ...
    public ResponseEntity<CompetitorComparisonResultDto> compare(@PathVariable UUID accountId,
                                                                   @PathVariable UUID competitorAccountId) {
        return ResponseEntity.ok(competitorComparisonApplicationService.compare(accountId, competitorAccountId));
    }
}
