...
public class ProposalController {
    ...
    public ResponseEntity<List<ContentProposalDto>> generate(@RequestBody ProposalGenerationRequest request) {
        return ResponseEntity.ok(proposalGenerationApplicationService.generate(request));
    }
