...
/** {@code buzz_score_history} テーブルに対応するJPAエンティティ。 */
@Entity
@Table(name = "buzz_score_history")
public class BuzzScoreHistoryEntity {
    ...
    protected BuzzScoreHistoryEntity() {
    }

    public BuzzScoreHistoryEntity(UUID id, UUID postId, double totalScore, Map<String, Double> breakdown,
